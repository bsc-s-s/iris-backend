...
export const v1 = {
  ...
  apiKeys: {
    ...
    create: (data: { name: string; scopes?: string; rateLimit?: number }) =>
      request<any>("/api-keys", { method: "POST", body: data }),
    revoke: (id: string) => request<any>(`/api-keys/${id}/revoke`, { method: "POST" }),
    delete: (id: string) => request<any>(`/api-keys/${id}`, { method: "DELETE" }),
  },
  webhooks: {
    list: () => request<any[]>("/webhooks"),
    create: (data: { name: string; url: string; events: string[]; retryCount?: number; timeout?: number }) =>
      request<any>("/webhooks", { method: "POST", body: data }),
    update: (id: string, data: any) => request<any>(`/webhooks/${id}`, { method: "PUT", body: data }),
    delete: (id: string) => request<any>(`/webhooks/${id}`, { method: "DELETE" }),
    events: (endpointId?: string) => request<any>(endpointId ? `/webhooks/events/${endpointId}` : "/webhooks/events"),
    test: (id: string) => request<any>(`/webhooks/test/${id}`, { method: "POST" }),
  },
  mfa: {
    setup: () => request<any>("/mfa/setup", { method: "POST" }),
    verify: (token: string) => request<any>("/mfa/verify", { method: "POST", body: { token } }),
    disable: () => request<any>("/mfa/disable", { method: "POST" }),
    status: () => request<any>("/mfa/status"),
  },
  sso: {
  ...
  gdpr: {
    ...
    dpo: {
      get: () => request<any>("/gdpr/dpo"),
      set: (data: any) => request<any>("/gdpr/dpo", { method: "POST", body: data }),
      remove: () => request<any>("/gdpr/dpo", { method: "DELETE" }),
    },
    dpia: {
      list: (status?: string) => request<any[]>("/gdpr/dpia", { params: status ? { status } : {} }),
      create: (data: any) => request<any>("/gdpr/dpia", { method: "POST", body: data }),
      get: (id: string) => request<any>(`/gdpr/dpia/${id}`),
      update: (id: string, data: any) => request<any>(`/gdpr/dpia/${id}`, { method: "PUT", body: data }),
      review: (id: string, data: any) => request<any>(`/gdpr/dpia/${id}/review`, { method: "PUT", body: data }),
      delete: (id: string) => request<any>(`/gdpr/dpia/${id}`, { method: "DELETE" }),
    },
    export: {
      create: (data?: any) => request<any>("/gdpr/export", { method: "POST", body: data || {} }),
      list: () => request<any[]>("/gdpr/exports"),
    },
    consent: {
      list: (userId?: string) => request<any[]>("/gdpr/consents", { params: userId ? { userId } : {} }),
      withdraw: (id: string) => request<any>(`/gdpr/consent/withdraw/${id}`, { method: "POST" }),
    },
    userConsent: {
      list: () => request<any[]>("/gdpr/user-consents"),
      accept: (data: any) => request<any>("/gdpr/user-consent", { method: "POST", body: data }),
    },
    transfers: {
      list: () => request<any[]>("/gdpr/transfers"),
      create: (data: any) => request<any>("/gdpr/transfers", { method: "POST", body: data }),
      update: (id: string, data: any) => request<any>(`/gdpr/transfers/${id}`, { method: "PUT", body: data }),
      delete: (id: string) => request<any>(`/gdpr/transfers/${id}`, { method: "DELETE" }),
    },
    dsr: {
      create: (data: any) => request<any>("/gdpr/subject-request", { method: "POST", body: data }),
      list: (status?: string) => request<any[]>("/gdpr/subject-requests", { params: status ? { status } : {} }),
      process: (id: string, data: any) => request<any>(`/gdpr/subject-request/${id}/process`, { method: "PUT", body: data }),
    },
    privacyPolicy: {
      get: (version?: string) => request<any>("/gdpr/privacy-policy", { params: version ? { version } : {} }),
      list: () => request<any[]>("/gdpr/privacy-policies"),
      create: (data: any) => request<any>("/gdpr/privacy-policy", { method: "POST", body: data }),
    },
    settings: {
      get: () => request<any>("/gdpr/settings"),
      update: (data: any) => request<any>("/gdpr/settings", { method: "PUT", body: data }),
    },
    retention: {
      list: () => request<any[]>("/gdpr/retention-policies"),
      upsert: (data: any) => request<any>("/gdpr/retention-policy", { method: "POST", body: data }),
    },
  },
  iso27001: {
    dashboard: () => request<any>("/iso27001/dashboard"),
    backup: {
      get: () => request<any>("/iso27001/backup"),
      update: (data: any) => request<any>("/iso27001/backup", { method: "PUT", body: data }),
      record: (data: any) => request<any>("/iso27001/backup/record", { method: "POST", body: data }),
    },
    drp: {
      get: () => request<any>("/iso27001/drp"),
      update: (data: any) => request<any>("/iso27001/drp", { method: "PUT", body: data }),
      test: (data: any) => request<any>("/iso27001/drp/test", { method: "POST", body: data }),
    },
    providers: {
      list: () => request<any[]>("/iso27001/providers"),
      create: (data: any) => request<any>("/iso27001/providers", { method: "POST", body: data }),
      update: (id: string, data: any) => request<any>(`/iso27001/providers/${id}`, { method: "PUT", body: data }),
      delete: (id: string) => request<any>(`/iso27001/providers/${id}`, { method: "DELETE" }),
    },
    encryptionKeys: {
      list: () => request<any[]>("/iso27001/encryption-keys"),
      create: (data: any) => request<any>("/iso27001/encryption-keys", { method: "POST", body: data }),
      rotate: (id: string) => request<any>(`/iso27001/encryption-keys/${id}/rotate`, { method: "POST" }),
      revoke: (id: string) => request<any>(`/iso27001/encryption-keys/${id}/revoke`, { method: "POST" }),
    },
    sensitiveFields: {
      list: () => request<any[]>("/iso27001/sensitive-fields"),
      upsert: (data: any) => request<any>("/iso27001/sensitive-fields", { method: "PUT", body: data }),
      delete: (id: string) => request<any>(`/iso27001/sensitive-fields/${id}`, { method: "DELETE" }),
    },
  },
  enterpriseCompliance: {
    dashboard: () => request<any>("/enterprise-compliance/dashboard"),
    summary: () => request<any>("/enterprise-compliance/summary"),
    auditTrail: (params?: Record<string, string>) => request<any>("/enterprise-compliance/audit-trail", { params }),
  },
};
...
export const api = {
  ...
  assessments: {
    ...
    generateProtocol: (id: string, type: string) =>
      request<any>(`/assessments/${id}/protocol/${type}`, { method: "POST" }),
